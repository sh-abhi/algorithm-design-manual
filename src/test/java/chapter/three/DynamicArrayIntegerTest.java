...
class DynamicArrayIntegerTest {
  ...
  void removeAtIndex() {
    ...
    dynamicArray.insert(7, 0);
    dynamicArray.display();
    Optional<Integer> optionalInteger = dynamicArray.remove(0);
    assertFalse(optionalInteger.isEmpty());
    Integer actual = optionalInteger.get();
